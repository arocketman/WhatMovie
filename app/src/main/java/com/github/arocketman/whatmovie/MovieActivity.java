...
public class MovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSwipeView.getBuilder()
                ...
                .setSwipeDecor(new SwipeDecor()
                        ...
                        .setSwipeInMsgLayoutId(R.layout.movie_swipe_in_msg_view)
                        .setSwipeOutMsgLayoutId(R.layout.movie_swipe_out_msg_view));
    ...
    class getMoviesTask extends AsyncTask<String, Void, ArrayList<Movie>> {
        ...
        protected ArrayList<Movie> doInBackground(String... params) {
            return new BasicConnector(getApplicationContext()).getMoviesByGenre("Comedy", 7, 1);
        }
